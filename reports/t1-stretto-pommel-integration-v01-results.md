...
Skill-14 Loaded Cut exact declaration damage is **3.830555555556**, matching the JSON value 3.830555… . The prose value 4.394 is wrong. This is a **report-only discrepancy**: flat 70% hit × exact mean of keep-highest-2d6+1 (5.472222…) = 3.830555…. The historical report was not silently rewritten; this and future reporting use the exact value.

`point_threat_events=0` was an **instrumentation bug**, not a state bug. The old integrated metrics dictionary initializes the field but has no increment site. Winding correctly sets threatening point. The candidate audit counts authored event-log transitions; its forced positive probe records 1 event and state `threatening`. Historical JSON remains unchanged.
...
|---|---|---|---|
| T1 actually reachable | raw-legal; 0 policy conversion | yes, explicit post-Cross window | yes, only on defender ordinary opportunity |
| Attacker H3 Rejoinder occurs | ordering undefined; engine leaves it open | no if T1; yes if declined | yes before T1 |
| D/M possible | raw options collapse after Close | only when T1 declined | yes before late T1 |
| Pressure used for | Rejoinder but stale after T1 | first Close opportunity | Rejoinder/ordinary initiative |
| Close entered | yes without ordering | during cover before Rejoinder use | later ordinary opportunity |
| First Close opportunity | undefined | Hart striker / Weich defender | current holder when defender declares |
| Spiritus | 1S | 1S | 1S after any earlier H3 spend |
| Chain | +1 | +1 | +1 after any earlier chain |
| Reciprocal risk | not authored | immediate and pressure-dependent | present but filtered by prior Rejoinder |
...
| Skill | Cost | Hit | E damage | Damage/S | P kill HP1 | HP4 | HP6 | HP8 |
|---|---|---|---|---|---|---|---|---|
| 10 | 1 | 50.0% | 2.250 | 2.250 | 50.0% | 33.3% | 16.7% | 0.0% |
| 10 | 2 | 50.0% | 2.250 | 1.125 | 50.0% | 33.3% | 16.7% | 0.0% |
| 12 | 1 | 60.0% | 2.700 | 2.700 | 60.0% | 40.0% | 20.0% | 0.0% |
| 12 | 2 | 60.0% | 2.700 | 1.350 | 60.0% | 40.0% | 20.0% | 0.0% |
| 14 | 1 | 70.0% | 3.150 | 3.150 | 70.0% | 46.7% | 23.3% | 0.0% |
| 14 | 2 | 70.0% | 3.150 | 1.575 | 70.0% | 46.7% | 23.3% | 0.0% |
| 18 | 1 | 90.0% | 4.050 | 4.050 | 90.0% | 60.0% | 30.0% | 0.0% |
| 18 | 2 | 90.0% | 4.050 | 2.025 | 90.0% | 60.0% | 30.0% | 0.0% |

Contextual reserve consequences:

| Reserve | Max P1 declarations | Max P2 declarations | Defender reserve after T1 |
|---|---|---|---|
| 1 | 1 | 0 | 0 |
| 2 | 2 | 1 | 1 |
| 3 | 3 | 1 | 2 |
...
| Skill | Pommel ownership | Pressure | Cross cancellation | First Close | E incoming | E outgoing |
|---|---|---|---|---|---|---|
| 10 | neither | Hart | 75.0% | striker | 0.000 | 0.000 |
| 10 | neither | Weich | 50.0% | defender | 0.000 | 0.000 |
| 10 | striker_only | Hart | 75.0% | striker | 2.250 | 0.000 |
| 10 | striker_only | Weich | 50.0% | defender | 2.250 | 0.000 |
| 10 | defender_only | Hart | 75.0% | striker | 0.000 | 2.250 |
| 10 | defender_only | Weich | 50.0% | defender | 0.000 | 2.250 |
| 10 | both | Hart | 75.0% | striker | 2.250 | 1.125 |
| 10 | both | Weich | 50.0% | defender | 1.125 | 2.250 |
| 14 | neither | Hart | 91.0% | striker | 0.000 | 0.000 |
| 14 | neither | Weich | 70.0% | defender | 0.000 | 0.000 |
| 14 | striker_only | Hart | 91.0% | striker | 3.150 | 0.000 |
| 14 | striker_only | Weich | 70.0% | defender | 3.150 | 0.000 |
| 14 | defender_only | Hart | 91.0% | striker | 0.000 | 3.150 |
| 14 | defender_only | Weich | 70.0% | defender | 0.000 | 3.150 |
| 14 | both | Hart | 91.0% | striker | 3.150 | 0.945 |
| 14 | both | Weich | 70.0% | defender | 0.945 | 3.150 |
| 18 | neither | Hart | 99.0% | striker | 0.000 | 0.000 |
| 18 | neither | Weich | 90.0% | defender | 0.000 | 0.000 |
| 18 | striker_only | Hart | 99.0% | striker | 4.050 | 0.000 |
| 18 | striker_only | Weich | 90.0% | defender | 4.050 | 0.000 |
| 18 | defender_only | Hart | 99.0% | striker | 0.000 | 4.050 |
| 18 | defender_only | Weich | 90.0% | defender | 0.000 | 4.050 |
| 18 | both | Hart | 99.0% | striker | 4.050 | 0.405 |
| 18 | both | Weich | 90.0% | defender | 0.405 | 4.050 |
...
| Ownership | Choice | Cancel | E incoming | E outgoing | P in kill | P out kill | E S | E chain | Owner first | Opp. first | Pommel conv | Contact | Open | Measure | Rejoinder |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| neither | Beat | 70.0% | 1.350 | 0.000 | 0.0% | 0.0% | 0.000 | 0.000 | 0.0% | 0.0% | 0.0% | none | yes | wide | no |
| neither | Hart Cross no T1 | 91.0% | 0.405 | 0.000 | 0.0% | 0.0% | 0.000 | 0.000 | 0.0% | 100.0% | 0.0% | crossing-wide | no | wide | yes |
| neither | Hart Cross + E1 T1 | 91.0% | 0.405 | 0.000 | 0.0% | 0.0% | 0.910 | 0.910 | 0.0% | 100.0% | 0.0% | crossing-close until hit/pass cleanup | no | close | no |
| neither | Weich Cross no T1 | 70.0% | 1.350 | 0.000 | 0.0% | 0.0% | 0.000 | 0.000 | 100.0% | 0.0% | 0.0% | crossing-wide | no | wide | yes |
| neither | Weich Cross + E1 T1 | 70.0% | 1.350 | 0.000 | 0.0% | 0.0% | 0.700 | 0.700 | 100.0% | 0.0% | 0.0% | crossing-close until hit/pass cleanup | no | close | no |
| striker_only | Beat | 70.0% | 1.350 | 0.000 | 0.0% | 0.0% | 0.000 | 0.000 | 0.0% | 0.0% | 0.0% | none | yes | wide | no |
| striker_only | Hart Cross no T1 | 91.0% | 0.405 | 0.000 | 0.0% | 0.0% | 0.000 | 0.000 | 0.0% | 100.0% | 0.0% | crossing-wide | no | wide | yes |
| striker_only | Hart Cross + E1 T1 | 91.0% | 3.272 | 0.000 | 0.0% | 0.0% | 2.730 | 1.820 | 0.0% | 100.0% | 100.0% | crossing-close until hit/pass cleanup | no | close | no |
| striker_only | Weich Cross no T1 | 70.0% | 1.350 | 0.000 | 0.0% | 0.0% | 0.000 | 0.000 | 100.0% | 0.0% | 0.0% | crossing-wide | no | wide | yes |
| striker_only | Weich Cross + E1 T1 | 70.0% | 3.555 | 0.000 | 0.0% | 0.0% | 2.100 | 1.400 | 100.0% | 0.0% | 100.0% | crossing-close until hit/pass cleanup | no | close | no |
| defender_only | Beat | 70.0% | 1.350 | 0.000 | 0.0% | 0.0% | 0.000 | 0.000 | 0.0% | 0.0% | 0.0% | none | yes | wide | no |
| defender_only | Hart Cross no T1 | 91.0% | 0.405 | 0.000 | 0.0% | 0.0% | 0.000 | 0.000 | 0.0% | 100.0% | 0.0% | crossing-wide | no | wide | yes |
| defender_only | Hart Cross + E1 T1 | 91.0% | 0.405 | 2.866 | 0.0% | 0.0% | 2.730 | 1.820 | 0.0% | 100.0% | 100.0% | crossing-close until hit/pass cleanup | no | close | no |
| defender_only | Weich Cross no T1 | 70.0% | 1.350 | 0.000 | 0.0% | 0.0% | 0.000 | 0.000 | 100.0% | 0.0% | 0.0% | crossing-wide | no | wide | yes |
| defender_only | Weich Cross + E1 T1 | 70.0% | 1.350 | 2.205 | 0.0% | 0.0% | 2.100 | 1.400 | 100.0% | 0.0% | 100.0% | crossing-close until hit/pass cleanup | no | close | no |
| both | Beat | 70.0% | 1.350 | 0.000 | 0.0% | 0.0% | 0.000 | 0.000 | 0.0% | 0.0% | 0.0% | none | yes | wide | no |
| both | Hart Cross no T1 | 91.0% | 0.405 | 0.000 | 0.0% | 0.0% | 0.000 | 0.000 | 0.0% | 100.0% | 0.0% | crossing-wide | no | wide | yes |
| both | Hart Cross + E1 T1 | 91.0% | 3.272 | 0.860 | 0.0% | 0.0% | 3.276 | 2.093 | 0.0% | 100.0% | 100.0% | crossing-close until hit/pass cleanup | no | close | no |
| both | Weich Cross no T1 | 70.0% | 1.350 | 0.000 | 0.0% | 0.0% | 0.000 | 0.000 | 100.0% | 0.0% | 0.0% | crossing-wide | no | wide | yes |
| both | Weich Cross + E1 T1 | 70.0% | 2.011 | 2.205 | 0.0% | 0.0% | 2.520 | 1.610 | 100.0% | 0.0% | 100.0% | crossing-close until hit/pass cleanup | no | close | no |
...
| Pressure | Attacker repertoire | Route | E attacker dmg | S | Chain | Opportunity | Measure | Unlocked/denied |
|---|---|---|---|---|---|---|---|---|
| Hart | none | A stay Wide | 0.000 | 0 | 0 | striker | wide | D/M and authored Wide Winden |
| Hart | none | B E1 Close | 0.000 | 1 | 1 | striker | close | Close only; Wide D/M/Winden gated out |
| Hart | none | C L1 late | 0.000 | 0 | 0 | governing Rejoinder first | close only after decline and defender opportunity; otherwise cleanup | Wide first; Close conditional |
| Hart | dm_only | A stay Wide | 2.047 | 2 | 1 | striker | wide | D/M and authored Wide Winden |
| Hart | dm_only | B E1 Close | 0.000 | 1 | 1 | striker | close | Close only; Wide D/M/Winden gated out |
| Hart | dm_only | C L1 late | 2.047 | 2 | 1 | governing Rejoinder first | close only after decline and defender opportunity; otherwise cleanup | Wide first; Close conditional |
| Hart | dm_fuhlen | A stay Wide | 4.095 | 3 | 1 | striker | wide | D/M and authored Wide Winden |
| Hart | dm_fuhlen | B E1 Close | 0.000 | 1 | 1 | striker | close | Close only; Wide D/M/Winden gated out |
| Hart | dm_fuhlen | C L1 late | 4.095 | 3 | 1 | governing Rejoinder first | close only after decline and defender opportunity; otherwise cleanup | Wide first; Close conditional |
| Hart | winden | A stay Wide | 3.150 | 2 | 1 | striker | wide | D/M and authored Wide Winden |
| Hart | winden | B E1 Close | 0.000 | 1 | 1 | striker | close | Close only; Wide D/M/Winden gated out |
| Hart | winden | C L1 late | 3.150 | 2 | 1 | governing Rejoinder first | close only after decline and defender opportunity; otherwise cleanup | Wide first; Close conditional |
| Hart | full_h3 | A stay Wide | 4.095 | 3 | 1 | striker | wide | D/M and authored Wide Winden |
| Hart | full_h3 | B E1 Close | 0.000 | 1 | 1 | striker | close | Close only; Wide D/M/Winden gated out |
| Hart | full_h3 | C L1 late | 4.095 | 3 | 1 | governing Rejoinder first | close only after decline and defender opportunity; otherwise cleanup | Wide first; Close conditional |
| Weich | none | A stay Wide | 0.000 | 0 | 0 | defender | wide | D/M and authored Wide Winden |
| Weich | none | B E1 Close | 0.000 | 1 | 1 | defender | close | Close only; Wide D/M/Winden gated out |
| Weich | none | C L1 late | 0.000 | 1 | 1 | governing Rejoinder first | close only after decline and defender opportunity; otherwise cleanup | Wide first; Close conditional |
| Weich | dm_only | A stay Wide | 2.047 | 2 | 1 | defender | wide | D/M and authored Wide Winden |
| Weich | dm_only | B E1 Close | 0.000 | 1 | 1 | defender | close | Close only; Wide D/M/Winden gated out |
| Weich | dm_only | C L1 late | 2.047 | 2 | 1 | governing Rejoinder first | close only after decline and defender opportunity; otherwise cleanup | Wide first; Close conditional |
| Weich | dm_fuhlen | A stay Wide | 4.095 | 3 | 1 | defender | wide | D/M and authored Wide Winden |
| Weich | dm_fuhlen | B E1 Close | 0.000 | 1 | 1 | defender | close | Close only; Wide D/M/Winden gated out |
| Weich | dm_fuhlen | C L1 late | 4.095 | 3 | 1 | governing Rejoinder first | close only after decline and defender opportunity; otherwise cleanup | Wide first; Close conditional |
| Weich | winden | A stay Wide | 0.000 | 0 | 0 | defender | wide | D/M and authored Wide Winden |
| Weich | winden | B E1 Close | 0.000 | 1 | 1 | defender | close | Close only; Wide D/M/Winden gated out |
| Weich | winden | C L1 late | 0.000 | 1 | 1 | governing Rejoinder first | close only after decline and defender opportunity; otherwise cleanup | Wide first; Close conditional |
| Weich | full_h3 | A stay Wide | 4.095 | 3 | 1 | defender | wide | D/M and authored Wide Winden |
| Weich | full_h3 | B E1 Close | 0.000 | 1 | 1 | defender | close | Close only; Wide D/M/Winden gated out |
| Weich | full_h3 | C L1 late | 4.095 | 3 | 1 | governing Rejoinder first | close only after decline and defender opportunity; otherwise cleanup | Wide first; Close conditional |
...
| Skill | Cost | Reserve | E declarations | Hit decl.1 | Hit by decl.2 | Cap reached | Resource stop | Pass term. |
|---|---|---|---|---|---|---|---|---|
| 10 | 1 | 1 | 0.000 | 0.0% | 0.0% | 0.0% | 100.0% | 0.0% |
| 10 | 1 | 2 | 1.500 | 50.0% | 75.0% | 50.0% | 0.0% | 0.0% |
| 10 | 1 | 3 | 1.500 | 50.0% | 75.0% | 50.0% | 0.0% | 0.0% |
| 10 | 1 | 4 | 1.500 | 50.0% | 75.0% | 50.0% | 0.0% | 0.0% |
| 10 | 1 | 8 | 1.500 | 50.0% | 75.0% | 50.0% | 0.0% | 0.0% |
| 10 | 2 | 1 | 0.000 | 0.0% | 0.0% | 0.0% | 100.0% | 100.0% |
| 10 | 2 | 2 | 0.000 | 0.0% | 0.0% | 0.0% | 100.0% | 0.0% |
| 10 | 2 | 3 | 1.500 | 50.0% | 75.0% | 50.0% | 0.0% | 0.0% |
| 10 | 2 | 4 | 1.500 | 50.0% | 75.0% | 50.0% | 0.0% | 0.0% |
| 10 | 2 | 8 | 1.500 | 50.0% | 75.0% | 50.0% | 0.0% | 0.0% |
| 12 | 1 | 1 | 0.000 | 0.0% | 0.0% | 0.0% | 100.0% | 0.0% |
| 12 | 1 | 2 | 1.400 | 60.0% | 84.0% | 40.0% | 0.0% | 0.0% |
| 12 | 1 | 3 | 1.400 | 60.0% | 84.0% | 40.0% | 0.0% | 0.0% |
| 12 | 1 | 4 | 1.400 | 60.0% | 84.0% | 40.0% | 0.0% | 0.0% |
| 12 | 1 | 8 | 1.400 | 60.0% | 84.0% | 40.0% | 0.0% | 0.0% |
| 12 | 2 | 1 | 0.000 | 0.0% | 0.0% | 0.0% | 100.0% | 100.0% |
| 12 | 2 | 2 | 0.000 | 0.0% | 0.0% | 0.0% | 100.0% | 0.0% |
| 12 | 2 | 3 | 1.400 | 60.0% | 84.0% | 40.0% | 0.0% | 0.0% |
| 12 | 2 | 4 | 1.400 | 60.0% | 84.0% | 40.0% | 0.0% | 0.0% |
| 12 | 2 | 8 | 1.400 | 60.0% | 84.0% | 40.0% | 0.0% | 0.0% |
| 14 | 1 | 1 | 0.000 | 0.0% | 0.0% | 0.0% | 100.0% | 0.0% |
| 14 | 1 | 2 | 1.300 | 70.0% | 91.0% | 30.0% | 0.0% | 0.0% |
| 14 | 1 | 3 | 1.300 | 70.0% | 91.0% | 30.0% | 0.0% | 0.0% |
| 14 | 1 | 4 | 1.300 | 70.0% | 91.0% | 30.0% | 0.0% | 0.0% |
| 14 | 1 | 8 | 1.300 | 70.0% | 91.0% | 30.0% | 0.0% | 0.0% |
| 14 | 2 | 1 | 0.000 | 0.0% | 0.0% | 0.0% | 100.0% | 100.0% |
| 14 | 2 | 2 | 0.000 | 0.0% | 0.0% | 0.0% | 100.0% | 0.0% |
| 14 | 2 | 3 | 1.300 | 70.0% | 91.0% | 30.0% | 0.0% | 0.0% |
| 14 | 2 | 4 | 1.300 | 70.0% | 91.0% | 30.0% | 0.0% | 0.0% |
| 14 | 2 | 8 | 1.300 | 70.0% | 91.0% | 30.0% | 0.0% | 0.0% |
| 18 | 1 | 1 | 0.000 | 0.0% | 0.0% | 0.0% | 100.0% | 0.0% |
| 18 | 1 | 2 | 1.100 | 90.0% | 99.0% | 10.0% | 0.0% | 0.0% |
| 18 | 1 | 3 | 1.100 | 90.0% | 99.0% | 10.0% | 0.0% | 0.0% |
| 18 | 1 | 4 | 1.100 | 90.0% | 99.0% | 10.0% | 0.0% | 0.0% |
| 18 | 1 | 8 | 1.100 | 90.0% | 99.0% | 10.0% | 0.0% | 0.0% |
| 18 | 2 | 1 | 0.000 | 0.0% | 0.0% | 0.0% | 100.0% | 100.0% |
| 18 | 2 | 2 | 0.000 | 0.0% | 0.0% | 0.0% | 100.0% | 0.0% |
| 18 | 2 | 3 | 1.100 | 90.0% | 99.0% | 10.0% | 0.0% | 0.0% |
| 18 | 2 | 4 | 1.100 | 90.0% | 99.0% | 10.0% | 0.0% | 0.0% |
| 18 | 2 | 8 | 1.100 | 90.0% | 99.0% | 10.0% | 0.0% | 0.0% |
...
Fixed seed 1308202601; 4000 samples per scenario; binomial 95% half-width at p=.5 is approximately 1.55%. Policies are transparent: Weich when either side has Pommel, Hart otherwise; avoid Hart T1 against opponent Pommel; use T1 to deny D/M or enable owned Close; P2 Pommel conserves an exact 2S against a fresh 8HP target.

| ID | Scenario | T1 opp | T1 dec | T1 conv | Pommel opp | Pommel dec | Pommel conv | H3 | Dmg A | Dmg B | Cleanup |
|---|---|---|---|---|---|---|---|---|---|---|---|
| C1 | Tutta/T1 vs Basics; neither Pommel | 2536 | 2536 | 100.0% | 0 | 0 | 0.0% | 0 | 1056 | 0 | 2536 |
| C2 | Tutta/T1+Pommel vs Basics | 1941 | 1941 | 100.0% | 2535 | 2535 | 100.0% | 0 | 3917 | 8094 | 1767 |
| C3 | Tutta/T1 vs opponent Pommel | 1971 | 0 | 0.0% | 0 | 0 | 0.0% | 1971 | 3684 | 0 | 0 |
| C4 | both know Pommel | 1921 | 1921 | 100.0% | 2496 | 2496 | 100.0% | 0 | 5784 | 6089 | 1749 |
| C5 | Tutta/T1 vs D/M+Fuhlen | 2544 | 2544 | 100.0% | 0 | 0 | 0.0% | 0 | 1138 | 0 | 2544 |
| C6 | Tutta/T1+Pommel vs Winden | 1994 | 1994 | 100.0% | 2604 | 2604 | 100.0% | 0 | 3778 | 8150 | 1827 |
| C7 | low-HP Tutta defender | 1957 | 1957 | 100.0% | 2598 | 2598 | 100.0% | 0 | 5787 | 5984 | 1768 |
| C8 | low-Spiritus Tutta defender | 1998 | 1998 | 100.0% | 0 | 0 | 0.0% | 0 | 3610 | 0 | 1998 |
| C9 | asymmetric Skill 10 vs 14 | 1338 | 1338 | 100.0% | 1743 | 1743 | 100.0% | 0 | 3864 | 4104 | 1129 |
| C10 | Beat control | 0 | 0 | 0.0% | 0 | 0 | 0.0% | 0 | 3726 | 0 | 1972 |
...
1. Yes: H3 129/129, 153 baseline tests, integrated tests, and both validators passed.
2. Yes. The governing H3 engine/data were left unchanged.
3. Yes. 3.830555… is correct; 4.394 is a report-only prose error.
4. Instrumentation issue: the counter had no increment site; state logic was correct.
5. Yes, within the adjudicated boundary: the Tutta record supports covering with a pass and entering stretto.
6. No. The source does not assign a universal owner-first Close attack.
7. No. Pommel is supported from established Close Crossing, not specifically T1.
8. No. Universal response denial is not cleanly source-supported.
9. Yes.
10. Yes, but it is less source-shaped and often unreachable after active H3.
11. E1.
12. L1 preserves H3 most literally; E1 is still compatible because it acts before Rejoinder use rather than rewriting H3.
13. No unjustified owner priority: the pre-authored Hart/Weich state assigns reciprocal first opportunity.
14. Yes. Close/Unknown is set before Rejoinder use, so Wide-gated D/M never opens from that transformed state.
15. Yes.
16. No. Both Winding variants are illegal after T1.
17. Yes.
18. Yes; pass, miss-transfer, and opponent-first Hart all preserve reciprocity.
19. No. Hart gives the striker first; Weich gives the owner first.
20. Yes, narrowly: Rejoinder denial, measure topology, and pass/escape consequences.
21. Yes. Hart can give that opponent immediate first Pommel.
22. Yes: Hart’s cancellation and Weich’s priority create ownership-sensitive variation.
23. No across meaningful shared states.
24. Yes: 0S separation, Open, no chain cost, and no reciprocal Close exposure.
25. Yes: better Hart cancellation/contact, denial of Wide Rejoinder, and authored Close access.
26. No severe exploit found; denial costs 1S/slot and can expose hostile Close repertoire.
27. Yes: it conserves T1 cost/slot and retains D/M/Winden/information branches.
28. Yes: it supplies guard/threat aftermath and a Wide geometry route without T1’s two-entry package.
29. Yes at P2; P1 is an incentive risk.
30. No.
31. Yes; it is too cheap at the 1S boundary for promotion.
32. Yes in the bounded matrix.
33. No; its narrow gate is offset by an immediate full flat attack and reciprocal miss risk.
34. Yes.
35. Yes; it permits a reciprocal second declaration but remains bounded by hit, resource, pass, and cap.
36. Yes. T1 plus two Pommels fills cap 3 and blocks a fourth learned declaration.
37. No stale bind state. Measure may remain Close only because the governing model explicitly preserves it independently of contact.
38. No.
39. No. Opponent pressure remains unknown until after the T1 decision.
40. Yes. E1 creates no Fühlen purchase; declining E1 restores ordinary Fühlen/H3 unchanged.
41. Yes. T1 requires the exact ordinary Basic-Cut/Cross source and does not trigger on authored-special crossings.
42. Yes.
43. Yes.
44. Yes.
45. Yes.
46. One.
47. One: P1’s low-reserve efficiency.
48. Mechanically yes for Project promotion review; not automatically promoted.
49. Not applicable to E1+P2; P1’s 1S efficiency blocks only P1.
50. Governing integration of T1/Close/Pommel, if Project approves; otherwise stop for adjudication rather than starting Named Guard v0.2.
