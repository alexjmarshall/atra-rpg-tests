...
Classification: **D: misunderstood field semantics, with ambiguous instrumentation**. JSON serialization matched the function return. v0.2 chose one ex-ante equal-prior fixed policy; blind D/M tied at q=.5 and an undocumented lexical tie selected Mutieren. That fixed label then appeared in both realized-pressure rows, including 40 Hart rows. No paired equal-prior aggregate or high-level conclusion changes, but those per-pressure labels are not conditional recommendations. v0.3 selects directly from each known-pressure vector, exposes tie sets, and tests serialization against the selector return.
...
| Skill | Variant | E declarations | E Spiritus | P hit ≤3 | P geometry change | P opponent Upper | P cap term |
|---|---|---|---|---|---|---|---|
| 10 | L1 | 1.75 | 3.5 | 0.875 | 0.0 | 0.0 | 0.125 |
| 10 | L2 | 1.75 | 3.5 | 0.875 | 0.5 | 0.5 | 0.125 |
| 12 | L1 | 1.56 | 3.12 | 0.936 | 0.0 | 0.0 | 0.064 |
| 12 | L2 | 1.56 | 3.12 | 0.936 | 0.4 | 0.4 | 0.064 |
| 14 | L1 | 1.39 | 2.78 | 0.973 | 0.0 | 0.0 | 0.027 |
| 14 | L2 | 1.39 | 2.78 | 0.973 | 0.3 | 0.3 | 0.027 |
| 18 | L1 | 1.11 | 2.22 | 0.999 | 0.0 | 0.0 | 0.001 |
| 18 | L2 | 1.11 | 2.22 | 0.999 | 0.1 | 0.1 | 0.001 |
...
| ID | Forced sequence | Legal | Terminal |
|---|---|---|---|
| A | Lower -> A Lower hit | True | normal damage; bind ends |
| B | Lower -> A Lower miss L1 -> B Lower | True | second declaration if B knows Winden/has 2S |
| C | Lower -> A Lower miss L2 -> Upper -> B Upper | True | interactive upper reply |
| D | Lower L2 miss -> B Upper miss -> A Upper | True | third learned declaration |
| E | third Winding miss -> fourth learned declaration | False | cap 3 |
| F | holder has <2S -> pass; opponent has <2S -> pass | True | resource/pass cleanup before cap |
| G | holder lacks Winden -> pass -> knowledgeable opponent acts | True | normal sequencing, no bonus |
...
- `data/plays/play-german-longsword-zornhau-ort.yaml`
